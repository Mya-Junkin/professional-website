...
const App = () => {
    ...
    return (
        ...
        <ButtonGroup 
                ...
                style={{position: 'sticky', top:0, padding: '2vh 5vw', display: 'flex', alignSelf: 'center', justifySelf: 'center'}}
            >
            {
                // TODO: Either style or theme button text to be text-transform uppercase
            }
            <Button onClick={() => handleClickScroll("skills section")} style={{border: '3px solid', borderColor: '#F4B301', color: '#F4B301', backgroundColor: '#2A2F35'}}>SKILLS</Button>
            <Button onClick={() => handleClickScroll("project section")} style={{border: '3px solid', borderColor: '#F4B301', color: '#F4B301', backgroundColor: '#2A2F35'}}>PROJECTS</Button>
            <Button onClick={() => handleClickScroll("about section")} style={{border: '3px solid', borderColor: '#F4B301', color: '#F4B301', backgroundColor: '#2A2F35'}}>ABOUT</Button>
            <Button onClick={() => handleClickScroll("contact section")} style={{border: '3px solid', borderColor: '#F4B301', color: '#F4B301', backgroundColor: '#2A2F35'}}>CONTACT</Button>
        </ButtonGroup>
        </ThemeProvider>
